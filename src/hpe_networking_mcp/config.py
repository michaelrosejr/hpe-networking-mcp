...
Secret file mapping (production — via docker-compose.secrets.yml overlay):
    ...
    /run/secrets/axis_api_token
    /run/secrets/aos8_host
    /run/secrets/aos8_username
    /run/secrets/aos8_password
    /run/secrets/aos8_port (optional, default 4343)
    /run/secrets/aos8_verify_ssl (optional, default true)
...
Environment variables (development — via .env file or shell export):
